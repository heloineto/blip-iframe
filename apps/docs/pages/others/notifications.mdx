...
import { NotificationsDemos, NotificationDemos } from '@/mantine-demos';
...
- `color, icon, title, radius, className, style, sx, loading` – props passed down to the [Notification](/core/notification/) component
